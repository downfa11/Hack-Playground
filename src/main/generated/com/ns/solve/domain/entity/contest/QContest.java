...
public class QContest extends EntityPathBase<Contest> {
    ...
    public final SetPath<com.ns.solve.domain.vo.ContestWargameKind, EnumPath<com.ns.solve.domain.vo.ContestWargameKind>> problemKinds = this.<com.ns.solve.domain.vo.ContestWargameKind, EnumPath<com.ns.solve.domain.vo.ContestWargameKind>>createSet("problemKinds", com.ns.solve.domain.vo.ContestWargameKind.class, EnumPath.class, PathInits.DIRECT2);
